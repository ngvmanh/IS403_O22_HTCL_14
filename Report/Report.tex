...
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=\linewidth]{bibliography/MLP/MLP_8_2_BID.jpg}
    \caption{MLP model's result with 8:2 splitting proportion}
    \label{fig15}
  \end{minipage}
\end{figure}
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=\linewidth]{bibliography/LSTM/bid8-2.png}
    \caption{LSTM model's result with 8:2 splitting proportion}
    \label{fig15}
  \end{minipage}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=\linewidth]{bibliography/MLP/MLP_8_2_CTG.jpg}
    \caption{MLP model's result with 8:2 splitting proportion}
    \label{fig22}
  \end{minipage}
\end{figure}
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=\linewidth]{bibliography/LSTM/ctg8-2.png}
    \caption{LSTM model's result with 8:2 splitting proportion}
    \label{fig22}
  \end{minipage}
\end{figure}
